const VERSION = 'v0.3.0-beta1';
const CACHE_PREFIX = 'samtalestotte:' + new URL(self.registration.scope).pathname + ':';
const CACHE_NAME = CACHE_PREFIX + VERSION;
const APP_SHELL = ['./', './index.html',
  './styles.css?v=0.3.0-beta1', './app.js?v=0.3.0-beta1', './lib.js?v=0.3.0-beta1',
  './language-model.js?v=0.3.0-beta1', './default-data.js?v=0.3.0-beta1', './manifest.webmanifest',
